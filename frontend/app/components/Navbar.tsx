...
export const Navbar = () => {
    ...
    return (
        <nav ref={navbarRef} className="fixed top-0 left-0 z-50 w-full border border-black border-t-0 rounded-b-md bg-background px-3 py-2 sm:px-5 md:flex md:items-center md:justify-between md:gap-6 md:py-3">
           
           
            <div className="min-w-0 flex flex-col">
                <div className="flex items-center gap-2 sm:gap-[0.5vw] w-full">
                    <div className="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full bg-transparent sm:h-16 sm:w-16">
                        <Image
                            src="/logo.png"
